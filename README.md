...
- **Moving** - PersonifyIt initially started off as a creative AI project that was used to create guides and photos for my home. I now use PersonifyIt to create framed artwork that I would print out and then customize them as gifts to my friends. Examples of guides include creating a QR guide for how to use my air tire compressor, a QR guide for how to restart my doorknob, and a QR guide on how to replace air filters. Examples of photos include printing out generative AI wedding art work.
- **Experience thinking like a product manager** - I wanted to learn more about entrepreneurship, business models, user engagement, and how to create products for myself and for others to use. Thanks to PersonifyIt, I had the opportunity to know what it was like to launch a product from the ground zero and to wear multiple hats.
